          ...
          return Card(
            ...
            child: ExpansionTile(
              ...
              subtitle: Column(
                ...
                children: [
                  Text(
                      'Total Harga: Rp${penjualan.totalHarga.toStringAsFixed(2)}'),
                  Text(
                      'Jumlah Dibayar: Rp${penjualan.jumlahDibayar.toStringAsFixed(2)}'),
                  Text(
                      'Kembalian: Rp${penjualan.kembalian.toStringAsFixed(2)}'),
                ],
              ),
              children: [
                Padding(
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, itemIndex) {
                          final produk =
                          penjualan.daftarProduk[itemIndex];
                          return ListTile(
